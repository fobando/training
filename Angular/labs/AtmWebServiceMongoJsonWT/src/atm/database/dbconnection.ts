...
export class DbConnection {
   ...
   /* place your own MONGODB credentials here */
    //mongodb://<dbuser>:<dbpassword>@ds014658.mlab.com:14658/atmwebservice
     private _userName   : string = "fobando";
     private _passWord   : string = "123456";
     private _dbName     : string = "atmwebservice";
     private _hostName   : string = "ds014658.mlab.com";
     private _portNumber : string = "14658";
